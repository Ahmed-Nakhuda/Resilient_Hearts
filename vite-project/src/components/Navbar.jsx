    ...
    const drawerContent = (
        <Box sx={{ width: 250, p: 2, background: 'linear-gradient(135deg, #1e88e5 0%, #42a5f5 100%)', height: '100%' }}>
            ...
            <List>
                ...
                {(isFacilitator) && (
                    <ListItem button onClick={() => handleNavigate('/upload-meeting')} sx={{ '&:hover': { bgcolor: 'rgba(255, 255, 255, 0.2)', animation: `${glow} 1.5s infinite` } }}>
                        <ListItemText primary="Facilitator Messages" sx={{ color: '#fff', textShadow: '1px 1px 2px rgba(0, 0, 0, 0.2)' }} />
                    </ListItem>
                )}
                  {(isFacilitator || isEnrolled) && (
                    <ListItem button onClick={() => handleNavigate('/join-meeting')} sx={{ '&:hover': { bgcolor: 'rgba(255, 255, 255, 0.2)', animation: `${glow} 1.5s infinite` } }}>
                        <ListItemText primary="Facilitator Messages" sx={{ color: '#fff', textShadow: '1px 1px 2px rgba(0, 0, 0, 0.2)' }} />
                    </ListItem>
                )}
            </List>
            ...
            <Toolbar sx={{ display: 'flex', justifyContent: 'space-between', py: 1.5 }}>
                ...
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                    ...
                    <Box sx={{ display: { xs: 'none', md: 'flex' }, gap: 1.5 }}>
                        ...
                        {(isFacilitator) && (
                            <Button 
                                onClick={() => handleNavigate('/upload-meeting')} 
                                sx={{ 
                                    color: '#fff', 
                                    fontWeight: 'bold', 
                                    textTransform: 'none',
